   ...
   return (
      <>
         ...
         <main className="w-full mx-auto px-2 lg:w-9/12 md:px-6 mt-4 lg:mt-6 flex flex-col md:flex-row justify-between gap-10">
            <section
               className="w-full md:w-[30rem] rounded-md p-6 h-72"
               style={{
                  backgroundColor: "hsla(50, 80%, 90%, 0.5)",
                  backgroundImage:
                     "linear-gradient(to right, hsl(var(--pc) / var(--tw-bg-opacity)), hsla(50, 80%, 90%, 0.5))",
               }}
            >
               {/* Card */}
               <div className="mb-10">
